...
void LCD_Display_Dir(uint8_t dir)
{
	...
	tp_dev.touchtype&=0xF8;
	tp_dev.touchtype|=lcddev.dir&0X07;
    if((dir==L2R_U2D)||(dir==L2R_D2U)||(dir==R2L_U2D)||(dir==R2L_D2U))//竖屏
    {
        
		lcddev.width=480;
		lcddev.height=800;
    }
	else if((dir==U2D_L2R)||(dir==U2D_R2L)||(dir==D2U_L2R)||(dir==D2U_R2L))//横屏
    {
		lcddev.width=800;
		lcddev.height=480;
    }
