  	...
  	if(twin!=NULL&&rbtn!=NULL)
	{
		...
		btn_draw(rbtn);	  		//画按键
 		...
 		gui_draw_rectangle(x+10-4,y+32+120+18,188,42,0X4A49);		//画边框
  		...
  		gui_phy.back_color=APP_WIN_BACK_COLOR;
		gui_show_ptstr(x+10,y+32+10,x+10+180,y+32+10+16,0,BLACK,16,(uint8_t*)sysset_system_about_caption_tbl[0][gui_phy.language],0);//ALIENTEK Mini
		...
		{	  
			...
			switch(selitem)//判断选择的条目
			{
				...
				case 11://关于
					...
					break;
				case 12:
					wifi_set((lcddev.width-200)/2,(lcddev.height-262)/2,scaption);
					break;
				default:
					break;
			}
