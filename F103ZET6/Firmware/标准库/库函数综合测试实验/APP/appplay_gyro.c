...
u8*const gyro_remindmsg_tbl[GUI_LANGUAGE_NUM]=
{
    "1,P8:PB10接GBC_RX,PB11接GBC_TX\r\
2,ATK MODULE接口插入MPU6050模块\r\
3,退出本应用后，请恢复原来的设置！",
    "1,P8:PB10接GBC_RX,PB11接GBC_TX\r\
2,ATK MODULE接口插入MPU6050模塊\r\
3,退出本應用後，請恢復原來的設置！",
    "1,P8:PB10-GBC_RX,PB11-GBC_TX\r\
2,Insert MPU6050 to ATK MODULE\r\
3,Exit,restore the orig settings",
};
...
u8 appplay_gyro(u8* caption)
{
    ...
    u16 ypr;
    u8 fsize;
    app_muti_remind_msg((lcddev.width-210)/2,(lcddev.height-140)/2,210,140,APP_REMIND_CAPTION_TBL[gui_phy.language],gyro_remindmsg_tbl[gui_phy.language]);
