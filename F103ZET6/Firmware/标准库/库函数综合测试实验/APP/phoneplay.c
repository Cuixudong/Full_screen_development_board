...
//来电任务
//设置任务优先级
#define PHONE_INCALL_TASK_PRIO      	1
//设置任务堆栈大小
...
//电话提示信息
u8*const phone_remind_tbl[5][GUI_LANGUAGE_NUM]=
{
    "拨号中...","撥號中...","Dialing...",
    "来电...","来电...","Calling...",
    "未找到GSM模块,请检查!","未找到GSM模塊,請檢查!","GSM Module Error!Please Check!",
    "SIM卡异常,请检查!","SIM卡異常,請檢查!","SIM Card Error!Please Check!",
    "内存不够,请退出当前APP！","內存不夠,請退出當前APP！","Mem Err,Pls quit cur APP！",
};
//键盘名称表
...
void phone_incall_task(void *pdata)
{
    ...
    {
        OSTaskSuspend(6); 	//挂起主任务
        window_msg_box((lcddev.width-220)/2,(lcddev.height-80)/2,220,80,"",(u8*)phone_remind_tbl[4][gui_phy.language],12,0,0X01|1<<6,0);
        sim900a_send_cmd("ATH","OK",200);	//挂机
        sim900a_cmd_over();//处理完毕
        OSTaskResume(6); 		//恢复主任务
    }
