...
u8 GT9147_Init(void)
{
    ...
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_1;				 // PB1端口配置 CS
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP; 		 //推挽输出
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
    GPIO_Init(GPIOB, &GPIO_InitStructure);//PB1推挽输出
    GPIO_SetBits(GPIOB,GPIO_Pin_1);

    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_0;				 // PB0端口配置 PEN
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPU; 		 //上拉输入
    GPIO_Init(GPIOB, &GPIO_InitStructure);//PB0上拉输入
    ...
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_0;				 // PC2端口配置 PEN
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPD; 		 //下拉输入
    GPIO_Init(GPIOB, &GPIO_InitStructure);//PF10下拉输入
